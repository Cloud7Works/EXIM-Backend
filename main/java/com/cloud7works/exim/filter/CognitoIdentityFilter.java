package com.cloud7works.exim.filter;
 ...
 * in the onStartup method from the {@link com.cloud7works.exim.StreamLambdaHandler} class.
 */
public class CognitoIdentityFilter implements Filter {
    public static final String COGNITO_IDENTITY_ATTRIBUTE = "com.cloud7works.exim.cognitoId";
